...
# 设定样本数目
data = data[0:180]  # Random 前三天PvOutput
...
pred_gru = prediction(GRU, test_x, test_y, 'GRU')
...
plt.plot(x, pred_gru, 'blue', label='GRU预测值')
